...
$content = apply_filters( 'the_content', get_the_content( __( 'Continue reading', 'die-jim-crow' ) ) );
	...
	<header class="entry-header">
		...
		<?php if ( 'post' == get_post_type() ) : ?>
			<div class="entry-meta">
				...
				<span class="entry-format">&mdash; <a href="<?php echo esc_url( get_post_format_link( 'video' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'die-jim-crow' ), get_post_format_string( 'video' ) ) ); ?>"><?php echo get_post_format_string( 'video' ); ?></a></span>
